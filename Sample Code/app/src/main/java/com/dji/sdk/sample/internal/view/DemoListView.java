...
import com.dji.sdk.sample.demo.remotecontrollersuas7.RemoteControllerSuas7; //<!-- SUAS 7 controller -->
...
import static com.dji.sdk.sample.R.string.component_listview_mobile_remote_controller;
...
public class DemoListView extends FrameLayout {
    ...
    private void initView(Context context) {
        ...
        builder.addGroup(R.string.component_listview_SUAS7_controller,
                false,
                new GroupItem(R.string.component_listview_SUAS7_mobile_remote_controller,
                        RemoteControllerSuas7.class));
